...
private:
    ...
    // GPS message buffer
    std::vector<GpsData> gps_msg_buffer;
    std::vector<GpsData> gps_publish_buffer;
    ...
    /*
        * @brief gpsCallback
        *    Callback function for the gps message
        * @param msg gps msg
    */
    ...
    /*
        * @brief publish gps path
        * @param time The time stamp of outpub msgs
    */
    void publishGPS(const ros::Time& time);
